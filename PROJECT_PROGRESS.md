...
| P2-07 | Add stateless, horizontally scalable public APIs only where required, with rate limiting. | Architecture review and load/security tests pass. | In progress |
